...
- **Доходы** — источники дохода (Шкулёв, Turnvoice, пособия жены) с планом-фактом за месяц, разбивкой «откуда пришло» (donut), владельцем (я/жена) и нуджами «пора продлить»; план дохода = сумма активных источников.
