...
**В работе / осталось:** подробный план — в [ROADMAP.md](ROADMAP.md). Кратко: бюджет по категориям (план-факт), графики капитала (линия net worth), событийные алерты, помесячная история дохода; данные-зависимое — сверка счёта жены, персональная инфляция; инфра — автодеплой (scope), чистка эмодзи в ответах бота.
