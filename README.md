...
- **Аналитика** — переключатель периода (месяц/квартал/год); доход/расход/накоплено + норма сбережений; доходы-vs-расходы по месяцам; сравнение с прошлым периодом по категориям (Δ%); структура расходов; топ-продавцы; подписки.
...
- **Капитал** — net worth (мультивалюта по курсу ЦБ), счета с правкой баланса, долги, запасной доход.
...
**Готово:** ингест (чеки/текст/голос/выписка) · категоризация с обучением + правка по позициям · дашборд с иконками и графиком · **вкладка «Операции» (список + фильтры + итог по выборке)** · **вкладка «Аналитика» (кэшфлоу, сравнение месяцев, топ-продавцы, норма сбережений)** · **вкладка «Доходы» (источники, план-факт, разбивка, нуджи)** · капитал (мультивалюта, долги, net worth) · safe-to-spend (от дохода по источникам) · цели + прогноз · регулярные + авто-детект · прогноз по категориям · дайджесты · бэкап · возвраты · редизайн под референсы · лёгкие миграции схемы.

**В работе / осталось:** подробный план — в [ROADMAP.md](ROADMAP.md). Кратко: обновление Главной (Δ к прошлому месяцу, мини-кэшфлоу), бюджет по категориям, графики капитала, событийные алерты, помесячная история дохода; данные-зависимое — сверка счёта жены, персональная инфляция; инфра — автодеплой (scope), чистка эмодзи в ответах бота.
