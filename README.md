...
**В работе / осталось:** подробный план — в [ROADMAP.md](ROADMAP.md). Кратко: графики капитала (линия net worth, Δ от сбережений/курса), событийные алерты, помесячная история дохода; данные-зависимое — сверка счёта жены, персональная инфляция; инфра — автодеплой (scope), чистка эмодзи в ответах бота.
