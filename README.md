...
**Готово:** ингест (чеки/текст/голос/выписка) · категоризация с обучением + правка по позициям · дашборд с иконками и графиком · **вкладка «Операции» (полный список + фильтры + итог по выборке)** · капитал (мультивалюта, долги, net worth) · safe-to-spend · цели + прогноз · регулярные + авто-детект · прогноз по категориям · дайджесты · бэкап · возвраты · редизайн под референсы.

**В работе / осталось:** подробный план — в [ROADMAP.md](ROADMAP.md). Кратко: доходы по источникам (план-факт), аналитика (тренды, сравнение месяцев), бюджет по категориям, графики капитала, событийные алерты; данные-зависимое — сверка счёта жены, персональная инфляция; инфра — автодеплой (scope), Alembic-миграции, чистка эмодзи в ответах бота.
